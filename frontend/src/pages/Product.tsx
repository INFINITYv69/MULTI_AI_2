...
export default function ProductPage() {
  ...
  const sendAudio = async (blob: Blob) => {
    ...
    try {
      ...
      // Result lives at res.data.insights (the agent pipeline output)
                ...
                <div className="glass-card p-6 bg-gradient-to-br from-primary/5 to-transparent border-primary/10">
                   <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="flex items-center gap-2">
                         ...
                         <span className="text-lg font-mono font-bold text-primary">{result.financial_health_score ?? 0}/100</span>
                      </div>
                   </div>
                   
                   <RiskGauge score={result.financial_health_score ?? 0} size="lg" />
                ...
                <div className="glass-card p-6 space-y-6">
                   <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                         <p className="text-sm text-foreground/90 leading-relaxed italic border-l-2 border-primary/30 pl-4">{result.summary_english || result.report?.summary_english || "No summary available."}</p>
                         <p className="text-sm text-muted-foreground leading-relaxed">{result.summary_hindi || result.report?.summary_hindi || ""}</p>
                      </div>
                   </div>
